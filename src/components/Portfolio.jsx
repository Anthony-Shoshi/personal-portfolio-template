...
const Portfolio = () => {
    return (
        <div className="lg:mx-12 mx-4 mb-32" id="portfolio">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-5">
                <div>
                    <h3 className="text-heading-color text-xl font-semibold mb-5">Recent Projects</h3>
                    <h1 className="text-heading-color md:text-6xl text-4xl font-bold sm:mb-20 mb-10">My Portfolio</h1>
                </div>
                <button className="bg-dribble mb-5 sm:mb-0 text-white border border-dribble transition-all duration-200 hover:translate-y-4 px-6 py-3 rounded hover:bg-white hover:text-dribble">
                    <svg
                        ...
                        viewBox="0 0 33 33"
                        fill="none"
                        className="w-8 h-8 inline-block mr-2 hover:"
                    >
                        <path
